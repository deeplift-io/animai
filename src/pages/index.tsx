import ImageCarousel from "@/features/dashboard/components/image-carousel";
import InviteModal from "@/features/dashboard/components/invite-modal";
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-md lg:shrink-0 xl:max-w-xl">
                  <h1 className="text-4xl tracking-tight text-gray-900 sm:text-6xl">
                    Your{" "}
                    <span className="text-transparent bg-clip-text bg-gradient-to-b from-lime-400 to-lime-500">
                      always on
                    </span>{" "}
