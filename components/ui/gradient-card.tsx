export default function GradientCard({ children }) {
  return (
      <div className="group shadow hover:shadow-lg cursor-pointer relative mx-auto w-full h-full overflow-hidden rounded-[16px] bg-gray-300 p-[1px] transition-all duration-300 ease-in-out bg-gradient-to-r from-indigo-800 via-purple-900 to-indigo-700">
